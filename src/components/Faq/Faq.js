...
const Faq = () => {
    return (
        <div>
            <h2 className='text-center mt-4 faq'>Frequently Asked Questions</h2>
            <div className='container'>
                <div className='mt-3'>
                    <Accordion className=''>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header className='faq-header'>What is blockchain oracle?</Accordion.Header>
                            <Accordion.Body>
                ...
                <div className='mt-3'>
                    <Accordion className=''>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header className='faq-header'>Why do blockchains need oracles?</Accordion.Header>
                            <Accordion.Body>
                ...
                <div className='mt-3'>
                    <Accordion className=''>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header className='faq-header'>What is the Chainlink Network?</Accordion.Header>
                            <Accordion.Body>
                ...
                <div className='mt-3'>
                    <Accordion className=''>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header className='faq-header'>Where can I explore the performance and reliability of the Chainlink Network?</Accordion.Header>
                            <Accordion.Body>
                ...
                <div className='mt-3'>
                    <Accordion className=''>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header className='faq-header'>What is Chainlink Verifiable Random Function (VRF)?</Accordion.Header>
                            <Accordion.Body>
                ...
                <div className='mt-3'>
                    <Accordion className=''>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header className='faq-header'>What is Chainlink Proof of Reserve?</Accordion.Header>
                            <Accordion.Body>
                ...
                <div className='mt-3'>
                    <Accordion className=''>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header className='faq-header'>Who can use Chainlink?</Accordion.Header>
                            <Accordion.Body>
                ...
                <div className='mt-3'>
                    <Accordion className=''>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header className='faq-header'>How do I keep up with current protocol development?</Accordion.Header>
                            <Accordion.Body>
                ...
                <div className='mt-3'>
                    <Accordion className=''>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header className='faq-header'>How can I reach out to Chainlink for support?</Accordion.Header>
                            <Accordion.Body>
                ...
                <div className='mt-3 mb-3'>
                    <Accordion className=''>
                        <Accordion.Item eventKey="0">
                            <Accordion.Header className='faq-header'>How do I participate in building Chainlink?</Accordion.Header>
                            <Accordion.Body>
